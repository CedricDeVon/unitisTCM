# E-Ballot Testing - Review
> Verify if a selected voter can review their supplied inputs successfully.
...
- Verify if all inputs supplied are identical during review
