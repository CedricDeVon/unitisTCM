# Election Testing - Remove
> Verify if a selected election can be removed successfully.
...
Scenario 1
 ...
 |  7 | Remove Election | Verify if action has been triggered | 

<br/>

**Post-conditions:**

- Verify if Election has been removed
