# Election Testing - Cancel
> Verify if a selected election can be canceled successfully.
...
Scenario 1
 ...
 |  7 | Cancel Election | Verify if action has been triggered | 

<br/>

**Post-conditions:**

- Verify if Election has been canceled
