# Election Testing - Close
> Verify if a selected election can be closed for voting successfully.
...
Scenario 1
 ...
 |  6 | Select Election | Verify if election has been selected | 
 |  7 | Close Election | Verify if action has been triggered | 

<br/>

**Post-conditions:**

- Verify if Election has been closed
