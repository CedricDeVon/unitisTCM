# Election Testing - View
> Verify if a selected election, including its related information, can be viewed successfully.
...
- Verify if one or more Elections can be viewed within the 'Happening Now' section
