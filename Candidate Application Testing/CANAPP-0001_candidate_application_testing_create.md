# Candidate Application Testing - Create
> Verify if an election candidate has been created successfully.
...
Scenario 1
 ...
 |  5 | Navigate to the application's 'Manage Candidate' page | Verify if navigation is successful | 
 |  6 | Supply all inputs | Verify if all relevant inputs have been set successfully | 
 |  7 | Create candidate | Verify if a notification has been displayed | 
