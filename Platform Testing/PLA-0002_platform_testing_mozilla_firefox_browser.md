# Platform Testing - Mozilla Firefox Browser
> Verify if the application runs on the Mozilla Firefox Browser successfully.
...
- Install the Mozilla Firefox Browser on both hardware

<br/>

Scenario 1 - Personal Computer
