# Platform Testing - Apple Safari Browser
> Verify if the application runs on the Apple Safari Browser successfully.
...
- Install the Apple Safari Browser on both hardware
