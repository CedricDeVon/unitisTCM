# Results Archiving Testing - Export
> Verify if the results of an archived election can be exported via file successfully.
...
Scenario 1
 ...
 |  4 | Click on the download icon | Verify if action starts the download process | 
 
<br/>

**Post-conditions:**

- Verify if download is in progress
